    ...
    public submitProfileEdit(){
        ...
        .then((response) => {          
          if(response.success == true){
            ...
            //console.log('=== after edit'+response.profile_img);
            if(response.profile_img != ''){
              jQuery("#imageprofileheader").attr("src",response.profile_img);
              localStorage.setItem('currentUserImage', response.profile_img);
            }
            this.closeModal();
            return true;
          }else{
