...
export class ChatDetailComponent {
    ...
    let finalcounting = parseInt(oldTotData) - this.tot_ele ;
    console.log('finalcounting = '+ finalcounting );
    let array = [1,2,3];
    for (let i = 0; i < this.stringifiedChatData.length; i++) {      
      console.log(this.stringifiedChatData[i].message);
