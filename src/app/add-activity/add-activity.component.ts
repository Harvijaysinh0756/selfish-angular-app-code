...
export class AddActivityComponent {
    ...
    ngOnInit(): void {
      ...
      this.loadScript().then(() =>{
        ...
        setTimeout(function(){          
          //jQuery("#location").attr("ngx-google-places-autocomplete","");
           ...
           // Initialize the search box and autocomplete
            ...
            autocomplete.addListener('place_changed', () => {
              ...
              // this.AddressChange(lat, lng, address);
            });
    ...
    loadScript() {
      ...
      return new Promise((resolve, reject) => {
        ...
        // element.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDavvVnam8kqA--AKQRLzuv8Rc-cnDIM3A&libraries=places&language=en';
        element.onload = resolve;
        element.onerror = reject;
        element.async = true;
        document.getElementsByTagName('head')[0].appendChild(element); 
        // this.elementRef.nativeElement.appendChild(element); // this one load in body
